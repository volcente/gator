...
VALUES ($1, $2, $3, $4, $5, $6)
RETURNING id, created_at, updated_at, name, url, author_id, last_fetched_at
`
...
func (q *Queries) DeleteFeedFollower(ctx context.Context, arg DeleteFeedFollowerParams) error {
	_, err := q.db.ExecContext(ctx, deleteFeedFollower, arg.FeedID, arg.UserID)
	return err
}

const getFeedByUrl = `-- name: GetFeedByUrl :one
SELECT id, created_at, updated_at, name, url, author_id, last_fetched_at FROM feeds WHERE url = $1 LIMIT 1
`
...
SELECT id, created_at, updated_at, name, url, author_id, last_fetched_at FROM feeds
